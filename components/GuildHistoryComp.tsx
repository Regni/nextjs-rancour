...
const GuildHistoryComp = ({ control }: Props) => {
  ...
  return (
    <FormItem className="space-y-2">
      <FormLabel className="text-lg font-semibold">Guild History</FormLabel>
      <FormDescription>
      ...
      <div className="space-y-6">
        ...
        {/* Second Guild */}
        <div>
          <h3 className="text-base font-medium mb-3">Previous Guild 1</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <FormField
              control={control}
        ...
        {/* Third Guild */}
        <div>
          <h3 className="text-base font-medium mb-3">Previous Guild 2</h3>
